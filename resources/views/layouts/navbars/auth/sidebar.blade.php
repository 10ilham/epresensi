<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
      ...
      <span class="ms-3 font-weight-bold">E-Presensi</span>
    </a>
  </div>
  ...
  <div class="" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item mt-2">
        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Pengaturan User</h6>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item mt-2">
        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Daftar Tabel</h6>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="#tablesMenu" data-bs-toggle="collapse">
          <!-- <a class="nav-link {{ (Request::is('tables') ? 'active' : '') }}" href="#tablesMenu" data-bs-toggle="collapse" aria-expanded="{{ Request::is('tables/*') ? 'true' : 'false' }}"> -->
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <div id="tablesMenu" class="collapse {{ Request::is('tables/*') ? 'show' : '' }}">
          <ul class="nav ms-4 ps-3">
            <li class="nav-item">
              <a class="nav-link {{ Request::is('tables/jurusan') ? 'active' : '' }}" href="{{ url('tables/jurusan') }}">
                <span class="sidenav-normal"> Jurusan </span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link {{ (Request::is('tables/matkul') ? 'active' : '') }}" href="{{ url('tables/matkul') }}">
                <span class="sidenav-normal"> Matkul </span>
              </a>
            </li>
          </ul>
        </div>
