          ...
          <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
            <div class="card card-plain mt-8">
              <div class="card-header pb-0 text-left bg-transparent">
                ...
                <p class="mb-0">Email <b>ilham@gmail.com</b></p>
              ...
              <div class="card-body">
                <form role="form" method="POST" action="/session">
                  ...
                  <label>Email</label>
                  <div class="mb-3">
                    <input type="email" class="form-control" name="email" id="email" placeholder="Email" value="ilham@gmail.com" aria-label="Email" aria-describedby="email-addon">
                    @error('email')
